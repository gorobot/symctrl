...
%   convergent power series method. While this method is formally defined as the
%   matrix exponential, in practice the computation of this matrix can cause
%   Matlab to hang. Symbolically, it is easier to compute the inverse laplace
%   transform of (sI-A)^-1, and less error-prone.
